...
\begin{document}
    \section{Funktionen}
        \input{src/1_Funktionen/folgen-reihen.tex}
        \subsection{Grenzwerte}
        \input{src/1_Funktionen/bernoulli_hopital.tex}
        \input{src/1_Funktionen/landau_symbole.tex}
        \input{src/1_Funktionen/eigenschaften.tex}
        \input{src/1_Funktionen/asymptoten.tex}
        \input{src/1_Funktionen/hyperbolische_funktionen.tex}
    \section{Komplexe Zahlen}
        \input{src/2_Komplexe_Zahlen/basics.tex}
        \input{src/2_Komplexe_Zahlen/nullstellen-reeller-Polynome.tex}
        \input{src/2_Komplexe_Zahlen/konjugierte.tex}
    \section{Potenzreihen}
        \input{src/3_Potenzreihen/allgemein.tex}
        \input{src/3_Potenzreihen/konvergenzradius.tex}
        \input{src/3_Potenzreihen/taylorreihen.tex}
    \section{Trigonometrie}
        \input{src/4_Trigonometrie/tabelle.tex}
        % \input{src/Trigonometrie/einheitskreis.tex}
        \input{src/4_Trigonometrie/rechenregeln.tex}
        \input{src/4_Trigonometrie/funktionsmodifikation.tex}
